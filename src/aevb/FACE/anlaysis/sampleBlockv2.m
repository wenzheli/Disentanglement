function [img1, img2, img3] = sampleBlock(name)
    ...
    borderUnit = (borderUp-borderLow)/nSpace;
   
    Coords = bsxfun(@plus, bsxfun(@times, repmat((0.5:1:nSpace)',[1,4]), borderUnit), borderLow);
