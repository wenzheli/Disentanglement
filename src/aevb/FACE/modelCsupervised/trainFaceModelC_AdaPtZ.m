...
% create a map between blocks and labels
% the default setting is:
%   the i-th block correspond to the i-th label
    ...
    for paramIter2 = 10:11  % 12 possible learning parameters
        ...
        for epoch = 1:NNsetting.nEpoch
            ...
            for batchIdx = 1:numBatch
                ...
                NN = blockFF(NN, NNsetting, dataTr(:,index(firstIdx:lastIdx)), yTr);
                ...
                if(rem(batchIdx,20)==1)
                    fprintf(2,'epoch %d, minibatch %d, recon & pred loss: %f, %s\n', ...
                        ...
                        num2str(NN.ftLossPred(epoch,:)/batchIdx/NNsetting.mbSize/NNsetting.L));
                end
            ...
            fprintf('epoch %d, log-likelihood is %f, %s\n', epoch, ...
                ...
                num2str(NN.ftLossPred(epoch,:)/nSamples/NNsetting.L));
