...
% initialize the NN parameters RANDOMLY
    ...
    if(strcmp(NN.shape, 'diag'))
        ...
        % need extra variables if use AdaDelta to optimize the parameters
    ...
    elseif(strcmp(NN.shape, 'block'))
        ...
        for classID = 1:NN.nClasses
            NN.Wc{classID} = (rand(NN.D2, NN.sizeClasses(classID))-0.5)/10;
            NN.bc{classID} = (rand(NN.sizeClasses(classID), 1)-0.5)/10;
            NN.dWc{classID} = NN.Wc{classID}*0; 
            NN.dbc{classID} = NN.bc{classID}*0;
        end
        ...
        if(strcmp(setting.alg,'adadelta'))
            ...
            for classID = 1:NN.nClasses
                NN.dWcE{classID} = NN.Wc{classID}*0;      
                NN.dbcE{classID} = NN.bc{classID}*0;
                NN.deltaWc{classID} = NN.Wc{classID}*0;   
                NN.deltabc{classID} = NN.bc{classID}*0;
                NN.deltaWcE{classID} = NN.Wc{classID}*0;  
                NN.deltabcE{classID} = NN.bc{classID}*0;
                NN.lrateWc{classID} = NN.Wc{classID}*0;   
                NN.lratebc{classID} = NN.bc{classID}*0;
            end
            
            for blockID = 1:NN.nBlocks
                NN.dW4E{blockID} = NN.W4{blockID}*0;      
                NN.deltaW4{blockID} = NN.W4{blockID}*0;   
                NN.deltaW4E{blockID} = NN.W4{blockID}*0;  
                NN.lrateW4{blockID} = NN.W4{blockID}*0;   
                ...
                NN.lrateW3{blockID} = NN.W3{blockID}*0;   
                NN.lrateb3{blockID} = NN.b3{blockID}*0;
                ...
                NN.lrateW2{blockID} = NN.W2{blockID}*0;   
                NN.lrateb2{blockID} = NN.b2{blockID}*0;
            end
            NN.dW1E = NN.W1*0;    	
            NN.db1E = NN.b1*0;
            NN.deltaW1 = NN.W1*0;  	
