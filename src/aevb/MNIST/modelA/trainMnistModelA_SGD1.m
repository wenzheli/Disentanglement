...
for paramIter1 = 1:2
    for paramIter2 = 1:6
        ...
        for epoch = 1:NNsetting.nEpoch
            ...
            if(epoch==1 || epoch==20)
                if(strcmp(alg, 'sgd'))
                    nameNN = ['modelA_dim' num2str(NN.D2) '_' num2str(NN.D1) 'epoch' num2str(epoch) 'SGD' num2str(learnParam) 'init' algInit '.mat'];
                elseif(strcmp(alg, 'adadelta'))
                    nameNN = ['modelA_dim' num2str(NN.D2) '_' num2str(NN.D1) 'epoch' num2str(epoch) 'Ada' num2str(learnParam) 'init' algInit '.mat'];
                end
