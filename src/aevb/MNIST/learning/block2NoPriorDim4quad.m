...
for hid = 1:nADA
    ...
    for epoch = 1:nEpoch
        ...
        for batchIdx = 1:numBatch
            if(earlyStop==0)
                ...
                delta0 = W2{1}*deltaEta{1} + W3{1}*deltaAM{1};
                for blockID = 2:nBlocks
                    delta0 = delta0 + W2{blockID}*deltaEta{blockID} + W3{blockID}*deltaAM{blockID};
                end
                ...
                for blockID = 1:nBlocks
                    ...
                    dW3{blockID} = h1*deltaAM{blockID}'/mbSize;
                ...
                for blockID = 1:nBlocks
                    db3{blockID} = sum(deltaAM{blockID},2)/mbSize;
    ...
    save(['aevbBlock2NWPriorDim4.mat'],'model');
end
